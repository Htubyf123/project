...
public class Chats extends TableImpl<ChatsRecord> {
     ...
     */
    public final TableField<ChatsRecord, Integer> CHAT_ID = createField(DSL.name("chat_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.chats.username</code>.
     */
    public final TableField<ChatsRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.CLOB, this, "");
